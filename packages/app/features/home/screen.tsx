...
export function HomeScreen({
  ...
  const handleSecondaryAction =
    onSecondaryAction ??
    (() => Linking.openURL("https://gurselcakar.com/monorepo"));
    ...
    <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
      <View className="px-6 py-12 items-center">
        ...
        <Text className="text-lg text-gray-600 leading-relaxed text-center mb-8">
          A production-ready monorepo template for building cross-platform
          applications with shared components between React Native and Next.js.
        </Text>
        ...
        <View className="flex-row flex-wrap gap-3 justify-center">
          ...
          />
          <Link href="/nativewind">
            <Pressable disabled className="inline-flex items-center justify-center w-auto px-4 py-3 border border-blue-600 rounded-lg">
          ...
          {onViewComponents ? (
            <Pressable
              className="px-5 py-2.5 active:opacity-80"
      ...
      <View className="px-6 pb-8 border-t border-gray-100 pt-8">
        ...
        <View className="flex-row flex-wrap gap-6">
          {technologies.map((tech) => (
            <View
              key={tech.name}
              className="flex-row items-start gap-4 w-[45%]"
            >
      ...
      <View className="px-6 pb-8 border-t border-gray-100 pt-8">
        ...
        <View className="bg-gray-900 rounded-lg p-5">
          <Text className="text-gray-400 font-mono text-sm mb-2">
            # Clone and install
          </Text>
          ...
          <Text className="text-gray-400 font-mono text-sm mb-2 mt-2">
            # Start development
          </Text>
